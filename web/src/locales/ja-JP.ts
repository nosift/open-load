export default {
  ...
  modelUsage: {
    analysisTitle: "モデルデータ分析",
    tabUsageShare: "成功呼び出し",
    tabUsageTrend: "失敗呼び出し",
    tabRequestShare: "呼び出し分布",
    tabRequestRank: "呼び出しランキング",
    requestShareTitle: "モデル呼び出し比率",
    total: "合計",
    successCount: "成功",
    failureCount: "エラー",
    retryCount: "再試行",
    ...
    rangeHint7d: "北京時間 直近7日",
    comingSoon: "準備中",
    comingSoonDesc: "この機能は近日公開予定です",
  },
  keys: {
    title: "キー管理",
