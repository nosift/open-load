export default {
  ...
  modelUsage: {
    analysisTitle: "模型数据分析",
    tabUsageShare: "调用成功",
    tabUsageTrend: "调用失败",
    tabRequestShare: "调用次数分布",
    tabRequestRank: "调用次数排行",
    requestShareTitle: "模型调用次数占比",
    total: "总计",
    successCount: "成功",
    failureCount: "错误",
    retryCount: "重试",
    ...
    rangeHint7d: "北京时间 近7天",
    comingSoon: "内容建设中",
    comingSoonDesc: "该模块稍后开放",
  },
  keys: {
    title: "密钥管理",
